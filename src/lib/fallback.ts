  ...
  const scenes = [
    {
      ...
      onScreenText: "Working software still needs a story.",
    ...
    },
    {
      ...
      onScreenText: "Signals become evidence.",
    ...
    },
    {
      ...
      onScreenText: "Judge the story before rendering.",
    ...
    },
    {
      ...
      narration: `The final output is a clean narrated pitch video with transcript, captured UI, and an editable scene plan for refinement.`,
      onScreenText: "A video you can refine.",
